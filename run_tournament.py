...
tournament_settings = {
    "agents": [
        ...
        {
            "class": "agents.agent4410.agent_4410.Agent4410",
            "parameters": {"storage_dir": "agent_storage/Agent4410"},
        },
        {
            "class": "agents.agentfish.agentfish.AgentFish",
            "parameters": {"storage_dir": "agent_storage/AgentFish"},
        },
        {
            "class": "agents.AgentFO2.AgentFO2.AgentFO2",
        ...
        {
            "class": "agents.LuckyAgent2022.LuckyAgent2022.LuckyAgent2022",
            "parameters": {"storage_dir": "agent_storage/LuckyAgent2022"},
        },
        {
            "class": "agents.BIU_agent.BIU_Agent.BIU_Agent",
